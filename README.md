...
As expected, the first two test scenarios pass, but in Scenario 2b, since the CSV import file does not match our data quality expectation (Employer Name is redacted in greater than 26.75% of the rows), the final **Then I append data...** step is SKIPPED, meaning our Snowflake production tables are left uncorrupted.
